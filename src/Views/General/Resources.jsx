...
const ResourcesPage = () => {
    ...
    return (
        <section className="flex flex-col items-center justify-center w-full py-12 gap-y-12">
            ...
            <div className="container relative flex flex-col items-start justify-between gap-20 pt-4 pb-16 lg:flex-row">
                ...
                <section className="relative w-full mb-6 ml-0 border-b-2 custom-div md:mb-12">
