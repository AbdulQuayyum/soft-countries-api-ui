...
const DashboardHeader = ({ setShowSidebar, user, forceRefetch }) => {
    ...
    return (
        <>
            <nav className={`dashboard-header-container ${user?.mode === "live" ? " !border-b-2 !border-b-green-500" : ""} ${user?.suspended ? " !bg-red-700" : ""}`}>
            ...
            {user?.suspended && <a href="/ContactUs" className=' text-red-700 font-bold text-xl'>You are currenly suspended contact our support to lift the ban</a>}
        </>
    )
}
